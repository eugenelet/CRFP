...
parser = argparse.ArgumentParser(description='MRCF')

### visdom setting
parser.add_argument('--visdom_port', type=int, default=8801,
                    help='Visdom execution port')
parser.add_argument('--visdom_view', type=str, default='MRCF',
                    help='Visdom execution view')
...
parser.add_argument('--log_file_name', type=str, default='MRCF.log',
                    help='Log file name')
parser.add_argument('--logger_name', type=str, default='MRCF',
                    help='Logger name')
...
parser.add_argument('--gpu_id', type=int, default=0,
                    help='The id of GPU used in training')

### dataset setting
parser.add_argument('--dataset', type=str, default='REDS',
                    help='Which dataset to train and test')
parser.add_argument('--dataset_dir', type=str, default='/Data/REDS_sharp/',
...
### model setting
parser.add_argument('--num_res_blocks', type=str, default='4+4+4+4',
                    help='The number of residual blocks in each stage')
parser.add_argument('--n_feats', type=int, default=64,
                    help='The number of channels in network')
parser.add_argument('--res_scale', type=float, default=1.,
                    help='Residual scale')
parser.add_argument('--cra', type=str2bool, default=True,
                    help='Use cra module or not')
parser.add_argument('--mrcf', type=str2bool, default=True,
                    help='MRCF or SRCF')
parser.add_argument('--y_only', type=str2bool, default=False,
                    help='Output Y-channel only or RGB-channels')
parser.add_argument('--hr_dcn', type=str2bool, default=True,
                    help='Move on DCN to highest spatial dimension or not')
parser.add_argument('--offset_prop', type=str2bool, default=True,
                    help='Propagate offset feature among each DCN or not')
...
parser.add_argument('--lr_rate', type=float, default=1e-4,
                    help='Learning rate')
parser.add_argument('--lr_rate_flow', type=float, default=2.5e-5,
                    help='Learning rate of optical flow estimater')
...
parser.add_argument('--GT_size', type=int, default=256,
                    help='Training GT size')
parser.add_argument('--FV_size', type=int, default=80,
                    help='Training FV size')
parser.add_argument('--scale', type=int, default=4,
                    help='Training upsampling scale')
parser.add_argument('--N_frames', type=int, default=15,
                    help='Training number of frames')
